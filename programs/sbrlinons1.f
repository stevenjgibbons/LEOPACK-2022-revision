C*********************************************************************
C                                                                    C
C Steve Gibbons - Mon Oct 29 13:54:05 WET 2001                       C
C                                                                    C
C Solid Body Rotation Linear Onset 1                                 C
C -     -    -        -      -     -                                 C
C                                                                    C
C*********************************************************************
      PROGRAM sbrlinons1
...
C
      DOUBLE PRECISION RI, RO, LOW, ZERO, CD, CI, CG, ROT, REYSBR,
     1                 X1, X2, CA, CE, CH, CB1, CB2, ARTOL, DRSV,
     2                 GRR, GRI, CTOL, CH1, CH2, CC, CF
C_____________________________________________________________________
C                                                                    C
...
C
C NR, INSPCF, LH, ISYM, MVAL, IOF, REYSBR
...
C
      ...
      PARAM( 14 ) = CF
C
      CALL IOCRBO( NR,INARR,MHT,MHL,MHM,MHP,MHTR,NBN,KL,NCFM,
     ...
     5   IN0,MT0,ML0,MM0,MP0,VEC0M,MVAL)
C
      CA  = PARAM(  1 )
      CB1 = PARAM(  2 )
      CB2 = PARAM(  3 )
