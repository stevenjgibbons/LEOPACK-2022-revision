...
C Steve Gibbons -                                                    C
C                                                                    C
C Kumar Roberts Critical Magnetic Reynolds Number Iterative Find     C
C -     -       -        -        -        -      -         -        C
C Wed Apr  4 16:46:48 WEST 2001                                      C
C                                                                    C
C*********************************************************************
      PROGRAM krcmrnif
      IMPLICIT NONE
...
C
 ...
 24   CONTINUE
     ...
     4       PPARR( NRUNS ), RM1ARR( NRUNS ), RM2ARR( NRUNS )
      GOTO 24
 300  CONTINUE
C
...
C
      IF ( CHST.NE.'S' .AND. CHST.NE.'O' ) GOTO 500
C
