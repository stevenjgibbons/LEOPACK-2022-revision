C*********************************************************************
C                                                                    C
C Steve Gibbons - Linear Onset 1.                                    C
...
C
 ...
 24   CONTINUE
     ...
     4       CGARR( NRUNS ), CHARR( NRUNS ), CIARR( NRUNS )
      GOTO 24
 300  CONTINUE
C
C
...
C
      ...
      PARAM(  8 ) = CI
C
C Enter desired value for PARAM( 9 )
C
      PARAM(  9 ) = 1.01d0
      PARAM( 10 ) = CTOL
C
      CALL  LOCRNF( NR, INARR, MHT, MHL, MHM, MHP, MHTR, NBN, KL,
