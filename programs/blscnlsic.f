...
C                                                                    C
C Thu Jun  8 09:27:05 BST 2000                                       C
C                                                                    C
C                                                                    C
C*********************************************************************
      PROGRAM blscnlsic
...
C
      IF ( IERR.GT.0 ) THEN
        ...
        WRITE ( LUCF  , 703 ) CF
        WRITE ( LUCG  , 703 ) CG
        WRITE ( LUCH  , 703 ) CH + DCH*DBLE( ICH )
        WRITE ( LUCI  , 703 ) CI
c       WRITE ( LURES , 707 ) CH + DCH*DBLE( ICH ), TOTKE
        WRITE ( LURI  , 703 ) RI
        WRITE ( LURO  , 703 ) RO
...
C
     ...
     1        GRR, GRI, EPSO
       ENDDO
       WRITE ( LURES , 708 ) CH + DCH*DBLE( ICH ), TOTKE, MMFLOQ,
     1        GRMAX, GIMAX, EPSO
