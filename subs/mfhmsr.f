C*********************************************************************
C subroutine Magnetic Field HarMonic Selection Routine ***************
C            -        -     -        -         -       ***************
C Steve Gibbons Wed Nov  3 10:32:19 GMT 1999                         C
C____________________________________________________________________C
C                                                                    C
C Fills MHT, MHL and MHM for a magnetic field only vector with       C
C lowest order, mlow, incremented by minc and capped by mmax - with  C
C L being filled up to LH.                                           C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE MFHMSR( ISYM, NH, MLOW, MINC, MMAX, NHMAX, MHT, MHL,
     1                   MHM, LH, LHMAX )
      IMPLICIT NONE
C____________________________________________________________________C
...
c
      IF ( OK ) RETURN
      PRINT *,' Subroutine MFHMSR. Your specifications'
