C*********************************************************************
C subroutine Arbitrary node Velocity cross Curl Velocity_0 Add *******
C            -              -              -    -        - -   *******
...
C
C*********************************************************************
      SUBROUTINE AVCV0A( NR, N1, N2, KL, KU, KLE, IMF, ILNRP, IRNRP,
     ...
     4    VEC0, SVFDC, XARR0, GAUX, GAUW, PA, DPA, FF1, FF2, FF3,
     5    VF1, VF2, VF3, QST  )
      IMPLICIT NONE
C____________________________________________________________________C
