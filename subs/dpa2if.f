C*********************************************************************
C subroutine Double Precision Array 2 Idl Format *********************
C            -      -         -     - -   -      *********************
C Steve Gibbons Thu Feb 24 15:54:47 GMT 2000                         C
C____________________________________________________________________C
C                                                                    C
C Given a double precision array DARR( N1, N2 ), DPA2IF will write   C
...
C
C*********************************************************************
      SUBROUTINE DPA2IF( N1, N2, LU, NCH, VARNAM, DARR )
      IMPLICIT NONE
C____________________________________________________________________C
