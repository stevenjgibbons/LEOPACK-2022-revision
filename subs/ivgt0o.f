C*********************************************************************
C subroutine Identical node Velocity . Gradient of Theta_0 add (Opt) *
C            -              -          -           -            -    *
C Steve Gibbons Tue Oct  9 09:45:36 WEST 2001                        C
...
C
C*********************************************************************
      SUBROUTINE IVGT0O( NR, N1, N2, KL, KU, KLE, IMF, ILN, IRN, INI,
