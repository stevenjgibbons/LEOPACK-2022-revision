C*********************************************************************
C subroutine New Imposed Vector Time Step routine (aZimuthal sym.) ***
C            -   -       -      -    -              -              ***
C Steve Gibbons Sat Jul 22 19:49:03 BST 2000                         C
...
C SFDDMF. NIVTSZ will advance the solution by one time step (size    C
C DELTAT).                                                           C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE NIVTSZ( KL, NBN, NCFM, NR, NDRVM, NH, NDCS, MHT, MHL,
...
C
     ...
     3             SF, VF, PA, DPA, GAUX, GAUW, SHC, DSHC, FDCM, RFI,
...
C
 ...
 81   FORMAT('nivtsz: Predictor norm = ',1PD16.7)
C
      ITMX = NOIT
      NOIT = 0
 50   CONTINUE
 ...
 83     FORMAT('nivtsz: Max. iterations exceeded.')
        NOIT = -1
        RETURN
      ENDIF
C
...
C
 ...
 84   FORMAT('nivtsz: Iteration ',I4,' Solution norm = ',1PD16.7)
