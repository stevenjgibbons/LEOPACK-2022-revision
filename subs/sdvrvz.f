...
C                                               -                    C
C Steve Gibbons Sat Jul 22 15:29:29 BST 2000                         C
...
C  Double Precision                                                  C
C  ----------------                                                  C
C     RVFZ      : Radial Vector Function. An array of dimensions     C
C		( 3, NPHPV, NTHPTS, NR) which contain the R, THETA   C
C 		   and PHI components of a VECTOR at each point      C
C                 ... i.e. RVFZ( 2, IPHI, ITHETA, IR ) is the Theta  C
...
C
C*********************************************************************
      SUBROUTINE SDVRVZ( NTHPTS, NPHPR, NPHPV, M0, LH, IRES, ILNR,
     1             IRNR, NR, INARR, MHT, MHL, MHM, MMAX, CHVMFF, V0,
     2             V1, GAUX, PA, DPA, RVFZ, FTF1, FTF2, FTF3, XARR)
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NTHPTS, NPHPR, NPHPV, M0, LH, IRES, NR, INARR( * ),
     1        MHT( * ), MHL( * ), MHM( * ), MMAX, ILNR, IRNR
...
C ...................................................................
        DO IPHI = 1, NPHPV
          RVFZ( 1, IPHI, ITHETA, IR ) = FTF1( 2*IPHI - 1 )
