C*********************************************************************
C subroutine Radial QSt to Radial Vector function : Optimise *********
C            -      ---    -      -                 -        *********
C Steve Gibbons Fri Jul 14 08:07:18 BST 2000                         C
...
C                                                                    C
C                 RVFO is completely zeroed on entry to RQSRVO.      C
C____________________________________________________________________C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE RQSRVO( RQSTO, RVFO, GAUX, PA, DPA, FTF1, FTF2, FTF3,
...
C ...................................................................
         DO IPHI = 1, NPHPTS
          RVFO( 1, IPHI, ITHETA, IR) = FTF1( 2*IPHI - 1 ) + ZCOEFA(IR)
