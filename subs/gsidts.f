C*********************************************************************
C subroutine General Semi-Implicit Dynamo Time Step routine          *
C            -         -    -        -      -    -                   *
...
C SFDDMF. GSIDTS will advance the solution by one time step (size    C
C DELTAT).                                                           C
...
C
 ...
 81   FORMAT('gsidts: Predictor norm = ',1PD16.7)
C
      ITMX = NOIT
      NOIT = 0
 50   CONTINUE
 ...
 83     FORMAT('gsidts: Max. iterations exceeded.')
        NOIT = -1
        RETURN
      ENDIF
C
...
C
 ...
 84   FORMAT('gsidts: Iteration ',I4,' Solution norm = ',1PD16.7)
