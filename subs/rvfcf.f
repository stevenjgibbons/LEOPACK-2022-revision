C*********************************************************************
C subroutine Radial Vector Function Coriolis Force *******************
C            -      -      -        -        -     *******************
C Steve Gibbons Tue May  9 16:55:20 BST 2000                         C
C____________________________________________________________________C
C Calculates coriolis vector CORV = K x V of V.                      C
C REPLACES RVF with the Coriolis force.                              C
C Use RVFCF2 to put K x V into a different array.                    C
C____________________________________________________________________C
C                                                                    C
C Input variables :-                                                 C
C ===============                                                    C
...
C
C*********************************************************************
      SUBROUTINE RVFCF ( NTHPTS, NPHPTS, NR, ILNR, IRNR, RVF, GAUX )
      IMPLICIT NONE
C____________________________________________________________________C
...
C      ............. loop around theta and phi points ................
       DO ITHETA = 1, NTHPTS
         ...
         DO IPHI = 1, NPHPTS
            ...
            RVF( IR, IPHI, ITHETA, 1 ) = -SINTH*VPHI
            RVF( IR, IPHI, ITHETA, 2 ) = -COSTH*VPHI
            RVF( IR, IPHI, ITHETA, 3 ) = COSTH*VTHE + SINTH*VR
         ENDDO
       ENDDO
