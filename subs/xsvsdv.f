C*********************************************************************
C subroutine Xtra Special Vector function 2 Spectrally Decomp. Vect. *
C            -    -       -                 -          -       -     *
C Steve Gibbons Thu Nov 30 16:12:16 MET 2000                         C
C____________________________________________________________________C
C                                                                    C
C The double precision array XSV contains a vector function of       C
C dimensions ( NCNX, NPHP, NTHP, NR ). XSVSDV transforms this back   C
...
C
C*********************************************************************
      SUBROUTINE XSVSDV( NTHP, NPHP, M0, LH, NR, ILNR, IRNR, NPH, MLP,
     1                   MMP, NTH, MLT, MMT, NCMX, ICMR, ICMT, ICMP,
     2                   QRF, SRF, TRF, GAUX, GAUW, PA, DPA, XSV,
     3                   FTF1, FTF2, FTF3 )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NTHP, NPHP, M0, LH, NR, ILNR, IRNR, NPH, MLP( NPH ),
     1        MMP( NPH ), NTH, MLT( NTH ), MMT( NTH ), NCMX, ICMR,
     2        ICMT, ICMP
