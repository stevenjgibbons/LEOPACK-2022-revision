C*********************************************************************
C subroutine Arbitrary node Velocity_0 . Gradient of Theta Add *******
C            -              -        -   -           -     -   *******
...
C VEC0 with grid spacing defined by XARR0.                           C
C                                                                    C
C____________________________________________________________________C
C                                                                    C
C Input variables :-                                                 C
...
C                                                                    C
C     NNDS      : Number of nodes available to take derivatives      C
C                  of raidal functions in VEC0.                      C
C                                                                    C
...
C     XARR0     : Dim ( NR0 ). i^{th} element gives x_i for VEC0.    C
...
C
C*********************************************************************
      SUBROUTINE AV0GTA( NR, N1, N2, KL, KU, KLE, IMF, ILN, IRN, INI,
     1    MTI, MLI, MMI, MPI, MTO, MLO, MMO, IN0, MT0, ML0, MM0,
     2    NBN, NDCS, NDRVS, NDRVM, NFDCM, NNDS, LH, NTHP, NPHP, MMAX,
     3    IWORK, WORK1, WORK2, WORKM, A, FAC, XARR, VEC0, SVFDC, 
     4    XARR0, GAUX, GAUW, PA, DPA, FF1, VF1, VF2, SF, SHC  )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
     ...
     3        MM0( * )
      INTEGER NBN, NDCS, NDRVS, NDRVM, NFDCM, NNDS, LH, NTHP, NPHP,
     1        MMAX, IWORK( NNDS )
      DOUBLE PRECISION A( N1, N2 ), FAC, XARR( NR ), VEC0( * ),
     1                 SVFDC( NFDCM , NR, NDRVM +1, NDCS  ),
     2                 XARR0( * ), GAUX( NTHP ), GAUW( NTHP )
...
C             .
              ...
              IPARS( 5 ) = LB
C             .
c             CALL INNLCA( N1, N2, KL, KU, KLE, IMF, IHB, IHG, INI,
c    1      IHD, NBN, ILN, IRN, NFDCM, NR, NDCS, IS, NDRVS, NDRVM,
c    2      IPARS, INVGTT, A, FAC, XARR, WORK, DPARS, SVFDC, IHA,
c    3      IHD0, NDCS0, IS0, NBN0, IN0, NDRVS0, NDRVM0, VEC0,
c    4      NFDCM0, SVFDC0 )
C             .
              CALL ANNLCA( N1, N2, KL, KU, KLE, IMF, IHB, IHG, INI,
     1      IHD, NBN, ILN, IRN, NFDCM, NR, NDCS, IS, NDRVS, NDRVM,
     2      IPARS, ANVGTT, A, FAC, XARR, WORK, DPARS, SVFDC, IHA,
     3      IHD0, NNDS, IN0, VEC0, XARR0, IWORK, WORK1, WORK2,
     4      WORKM )
C             .
 52         CONTINUE
