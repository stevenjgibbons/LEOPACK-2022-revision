C*********************************************************************
C subroutine Recalled Coefficient curl (K Cross Velocity) Add ********
C            -        -                 - -     -         -   ********
C Steve Gibbons Wed Feb  2 12:19:43 GMT 2000                         C
C____________________________________________________________________C
C                                                                    C
C Given a velocity which is stored in VECA (indexed by INARRA, MTA,  C
C MLA, MMA, MPA) and the arrays calculated by CFVICC (i.e. IHNALP,   C
...
C
C*********************************************************************
      SUBROUTINE RCKCVA( NVI, IHNALP, IHNGAM, INARRA, MTA,
     1          MLA, MMA, MPA, INARRG, MTG, MLG, MMG, ILNP, IRNP,
     2          ILNT, IRNT, NR, NBN, NDRVS, NDRVM, NCFM, NDCS, TVHI,
     3          CVI, VECA, VECG, XARR, SVFDC, FAC )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NVI, IHNALP( * ), IHNGAM( * ), INARRA(3),
     1        MTA( * ), MLA( * ), MMA( * ), MPA( * ), INARRG(3),
     2        MTG( * ), MLG( * ), MMG( * ), ILNP, IRNP, ILNT, IRNT
      INTEGER NDRVS, NDRVM, NCFM, NDCS, NR, NBN
      CHARACTER *(4) TVHI( * )
      DOUBLE PRECISION CVI( * ), VECA( * ), VECG( * ), XARR( NR ),
     1                 SVFDC( NCFM, NR, NDRVM+1, NDCS ), FAC
C____________________________________________________________________C
C Variable declarations - Working variables .........................C
C
      INTEGER LA, IR, ISA, IHA, IHG, INDA, INDG,
     1        LOCG, INDFUN, ISHCIA, NRRA, NRRG, NHA, NHG, LG
      DOUBLE PRECISION RAD, COEF, TERM, SHNKCV, LOW
      CHARACTER *(4) REQVIT
      LOGICAL OK
...
C           .
            ...
            DO IR = ILNP, IRNP
              ...
              TERM = SHNKCV( IR, RAD, NBN, REQVIT, NR, NDRVS, NDRVM,
     1           NCFM, NDCS, SVFDC, LA, VECA, IHA, ISA, INARRA, LG )
