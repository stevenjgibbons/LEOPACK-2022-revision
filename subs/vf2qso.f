C*********************************************************************
C subroutine Vector Function TO QSt coefficients (Optimised) *********
C            -      -        -- --                -          *********
C Steve Gibbons Mon Oct  8 15:14:32 WEST 2001                        C
...
C
C*********************************************************************
      SUBROUTINE VF2QSO( QST, VF, GAUX, GAUW, PA, DPA, FTF1, FTF2,
     1                   FTF3, ZCOEF, LH, NTHPTS, NPHPTS, MMAX, M0 )
      IMPLICIT NONE
C____________________________________________________________________C
...
C Variable declarations - Working variables .........................C
      INTEGER IOP, ISIGN, ITHREE, ITHETA, MM, IFTFC, IFTFS,
...
C ___ CASE M = 0 ___ ************************************************
     ...
     1                          W1*PA( IP, ITHETA )*FTF1( IFTFC )
            QST( INDCOS, 2 ) = QST( INDCOS, 2) +
     1                          W2*DPA( IP, ITHETA )*FTF2( IFTFC )
            QST( INDCOS, 3 ) = QST( INDCOS, 3) +
     1                          W2*DPA( IP, ITHETA )*FTF3( IFTFC )
C
C ___ Looping around from 1 to L ___ ********************************
C
            DO MM = 1, MIN( MMAX, L )/M0
               M      = MM*M0
               IP     = L*(L+1)/2+M+1
