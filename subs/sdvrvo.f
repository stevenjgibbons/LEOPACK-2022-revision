C*********************************************************************
C subroutine Stored Derivative Vector to Radial Vector Function ******
C            -      -          -         -      -      -        ******
C Steve Gibbons Fri Jul 14 15:26:57 BST 2000                         C
...
C
C*********************************************************************
      SUBROUTINE SDVRVO( NTHPTS, NPHPTS, LH, IRES, ILNR, IRNR, NR,
     1                   INARR, MHT, MHL, MHM, MMAX, CHVMFF, V0, V1,
     2                   GAUX, PA, DPA, RVFO, FTF1, FTF2, FTF3, XARR)
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NTHPTS, NPHPTS, LH, IRES, NR, INARR( * ), MHT( * ),
     1        MHL( * ), MHM( * ), MMAX, ILNR, IRNR
      DOUBLE PRECISION V0( * ), V1( * ), XARR( NR ), 
     1                 RVFO( 3, NPHPTS, NTHPTS, NR), GAUX( NTHPTS )
...
C Variable declarations - Working variables .........................C
     ...
     2        IT, INDSAM, INDDIF, IR, IND, INDFUN
      DOUBLE PRECISION ZERO, X, SINE, RAD, DPTERM, DTTERM,
     1        PTERM, QFAC, SFAC, TFAC, TOL, D0F, D1F
...
C
      IOP = 0
C ............. set RVFO array to zero
      CALL QUADOP ( RVFO, ZERO, ITHREE, NPHPTS, NTHPTS, NR, IOP )
C
...
C ...................................................................
        DO IPHI = 1, NPHPTS
          RVFO( 1, IPHI, ITHETA, IR ) = FTF1( 2*IPHI - 1 )
          RVFO( 2, IPHI, ITHETA, IR ) = FTF2( 2*IPHI - 1 )
          RVFO( 3, IPHI, ITHETA, IR ) = FTF3( 2*IPHI - 1 )
        ENDDO
C
       ENDDO
