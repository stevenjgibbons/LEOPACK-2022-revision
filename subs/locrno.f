C*********************************************************************
C subroutine Linear Onset Critical Rayleigh Number find (Optimised) **
C            -      -     -        -        -            -          **
C Steve Gibbons Tue Oct  9 13:07:47 WEST 2001                        C
...
C
C*********************************************************************
      SUBROUTINE LOCRNO( NR, INARR, MHT, MHL, MHM, MHP, MHTR, NBN, KL,
...
C
      CALL AVMLTO( NR, INARR, MHT, MHL, MHM, MHP, MHTR, NBN, KL,
     1             NCFM, NDRVM, SVFDC, A, N1, N2, NDCS, XARR,
     2             NTHP, NPHP, MVAL, LH, GAUX, GAUW, PA, DPA,
     3             F1, F2, F3, VF, QST, PARAM, ICLS, M0 )
C
