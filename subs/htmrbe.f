C*********************************************************************
C subroutine Homogeneous TeMperature Rhs Boundary cond. Enforce ******
C            -           -           -   -              -       ******
...
C
C*********************************************************************
      SUBROUTINE HTMRBE( N2, NR, INARR, MHTO, RHS, CHBND)
      IMPLICIT NONE
C____________________________________________________________________C
...
C     .
      ...
      ENDIF
C     .
      PRINT *,' Subroutine HTMRBE. CHBND = ', CHBND
      PRINT *,' Program aborted.'
      STOP
C     .
 50   CONTINUE
...
C       .
C       . Harmonic is a temperature harmonic
C       .
