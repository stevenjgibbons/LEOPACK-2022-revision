C*********************************************************************
C subroutine Conducting Inner Core Dynamo Time Step routine          *
C            -          -     -    -      -    -                     *
C Steve Gibbons Tue Apr  4 08:44:57 BST 2000                         C
...
C SFDDMF. CICDTS will advance the solution by one time step (size    C
C DELTAT).                                                           C
...
C
C*********************************************************************
      SUBROUTINE CICDTS( KLV, KLMF, NBN, NCFM, NR, NRMF, NHV, NHM, 
...
C
     ...
     1        MHIBCM( * ), MHOBCM( * ), NTS, NNDS
C
      DOUBLE PRECISION VECV( * ), VECV1( * ),
     1                 VECM( * ), VECM1( * )
C
...
C Variable declarations - Working variables .........................C
     ...
     1        IOP, INC, NBANDV, NBANDM, IPIVH( 3 ), ILUDF, NRHS, INFO
...
C
     ...
     2             DM2 )
C
C Store the diffusion parts of the velocity forcing term in DTVV
C
...
C
 ...
 81   FORMAT('cicdts: Predictor norm = ',1PD16.7)
C
      ITMX = NOIT
      NOIT = 0
 50   CONTINUE
 ...
 83     FORMAT('cicdts: Max. iterations exceeded.')
        NOIT = -1
        RETURN
      ENDIF
C
...
C
 ...
 84   FORMAT('cicdts: Iteration ',I4,' Solution norm = ',1PD16.7)
