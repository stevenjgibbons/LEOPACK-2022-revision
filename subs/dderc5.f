C*********************************************************************
C subroutine Double precision DERivative Calulate - 5 coefficients ***
C            -                ---        -          -              ***
...
C
C*********************************************************************
      SUBROUTINE DDERC5 ( COEF1, F1, COEF2, F2, COEF3, F3,
     1                    COEF4, F4, COEF5, F5,
     2                    D1F, D2F, D3F, D4F )
      IMPLICIT NONE
C____________________________________________________________________C
