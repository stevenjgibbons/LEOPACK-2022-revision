C*********************************************************************
C subroutine Recalled Coefficient Magnetic Advection Term Addition  **
C            -        -           -        -         -    -         **
C Steve Gibbons Wed Feb  2 15:43:22 GMT 2000                         C
C____________________________________________________________________C
C                                                                    C
C Given a Velocity which is stored in VECA (indexed by INARRA,       C
C MHTA, MHLA, MHMA, MHPA), a mag. field which is stored in VECB      C
...
C
C*********************************************************************
      SUBROUTINE RCMATA( NVI, IHNALP, IHNBET, IHNGAM, INARRA, MTA,
...
C
     ...
     2        LG
      DOUBLE PRECISION RAD, COEF, TERM, SHNMAT, LOW
      CHARACTER *(4) REQVIT
      LOGICAL OK
...
C              .
               ...
               DO IR = ILNP, IRNP
                 ...
                 TERM = SHNMAT( IR, RAD, NBN, REQVIT, NR, NDRVS,
