C*********************************************************************
C subroutine Magnetic Field Standard Eigenvalue Problem Solve ********
C            -        -     -        -          -       -     ********
C Steve Gibbons Mon Jan 31 09:17:59 GMT 2000                         C
C____________________________________________________________________C
C                                                                    C
C Solves the simplest eigenvalue problem for linear stability        C
C of a magnetic field.                                               C
C                                                                    C
C sigma CMTD B = [Forcing term] B                                    C
C                                                                    C
C where CMTD is passed in as a double precision scalar (normally =1) C
C                                                                    C
C____________________________________________________________________C
C                                                                    C
C  Integer                                                           C
...
C                                                                    C
C     CMTD      : Coefficient of magnetic time derivative (=1?)      C
C                                                                    C
C  Logical                                                           C
C  -------                                                           C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE MFSEPS( NR, INARR, MHT, MHL, MHM, MHP, NBN, KL,
...
C Variable declarations - Parameters ................................C
     ...
     2                 WORKEV( 3*NCVM ), WORKD( 3*N2 ), CMTD,
...
C     .
     ...
     1           MHT, MHL, MHM, ICMP, FAC, ILN, IRN, A,
...
C       .
     ...
     2              ICMP, FAC, ILN, IRN, NBN, NDRVS, NDRVM,
     3              NCFM, SVFDC )
C       .
        ICMP = 5
        CALL ASVTA( NR, NDCS, WORKD( IPN1 ), INARR, MHT, MHL, MHM,
...
C         .
     ...
     1              ICMP, MHP, W2, INARR, MHT, MHL, MHM,
     2              ICMP, FAC, ILN, IRN, NBN, NDRVS, NDRVM,
     3              NCFM, SVFDC )
C         .
          ICMP = 5
