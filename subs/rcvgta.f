C*********************************************************************
C subroutine Recalled Coefficient Velocity dot Grad Theta Add ********
C            -        -           -            -    -     -   ********
...
C
C*********************************************************************
      SUBROUTINE RCVGTA( NVI, IHNALP, IHNBET, IHNGAM, INARRA, MTA,
...
C
     ...
     1        LOCG, INDFUN, ISHCIA, NRRA, NRRB, NRRG, NHA, NHB, NHG
      DOUBLE PRECISION RAD, COEF, TERM, SHNVGT, LOW
      CHARACTER *(4) REQVIT
...
C           .
            DO IR = ILN, IRN
              ...
              TERM = SHNVGT( IR, RAD, NBN, REQVIT, NR, NDRVS, NDRVM,
