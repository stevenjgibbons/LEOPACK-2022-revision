C*********************************************************************
C subroutine Recalled coefficient Velocity_0 cross Mag. Field Add ****
C            -                    -        -       -    -     -   ****
C Steve Gibbons Fri Jan 28 11:05:17 GMT 2000                         C
C____________________________________________________________________C
C                                                                    C
C Adds the curl ( v_0 x B ) terms from the matrix for solving        C
C the induction equation. The v_0 terms are contained in a vector    C
C VEC0 which has the same grid spacing as that in the matrix         C
C (NR grid points defined by the array XARR).                        C
C                                                                    C
C RV0MFA searches through the arrays IHNALP, IHNBET, IHNGAM and TVHI C
C (as pre-calculated by VCPCC) with the help of VICEXR for           C
...
C
C*********************************************************************
      SUBROUTINE RV0MFA( NR, N1, N2, KL, KU, KLE, IMF, ILNRP, IRNRP,
...
C                 .
     ...
     2      NDRVM, IPARS, INVMFT, A, FAC, XARR, WORK, DPARS, SVFDC,
