C*********************************************************************
C subroutine Arbitrary node Velocity . Gradient of Theta_0 Add *******
C            -              -          -           -       -   *******
...
C
C*********************************************************************
      SUBROUTINE AVGT0A( NR, N1, N2, KL, KU, KLE, IMF, ILN, IRN, INI,
...
C             .
              ...
              IPARS( 5 ) = LB
C             .
c             CALL INNLCA( N1, N2, KL, KU, KLE, IMF, IHA, IHG, INI,
c    1      IHD, NBN, ILN, IRN, NFDCM, NR, NDCS, IS, NDRVS, NDRVM,
c    2      IPARS, INVGTT, A, FAC, XARR, WORK, DPARS, SVFDC, IHB,
c    3      IHD0, NDCS0, IS0, NBN0, IN0, NDRVS0, NDRVM0, VEC0,
c    4      NFDCM0, SVFDC0 )
C             .
              CALL ANNLCA( N1, N2, KL, KU, KLE, IMF, IHA, IHG, INI,
     1      IHD, NBN, ILN, IRN, NFDCM, NR, NDCS, IS, NDRVS, NDRVM,
     2      IPARS, ANVGTT, A, FAC, XARR, WORK, DPARS, SVFDC, IHB,
