C*********************************************************************
C subroutine Insulating Magnetic Field Rhs Boundary cond. Enforce ****
C            -          -        -     -   -              -       ****
...
C the equation A x = rhs, once x has been treated by IMFMBE.         C
C                                                                    C
C____________________________________________________________________C
C Input variables :-                                                 C
C ===============                                                    C
...
C
C*********************************************************************
      SUBROUTINE IMFRBE( N2, NR, INARR, MHTO, RHS, CHBND)
      IMPLICIT NONE
C____________________________________________________________________C
...
C Variable declarations - Working variables .........................C
      INTEGER NRR, NH, IHR, IRR, NRC, INDFUN
...
C     .
      ...
      ENDIF
C     .
      PRINT *,' Subroutine IMFRBE. CHBND = ', CHBND
      PRINT *,' Program aborted.'
      STOP
C     .
 50   CONTINUE
C     .
      DO IHR = 1, NH
        IF ( MHTO( IHR ).NE.4 .AND. MHTO( IHR ).NE.5 ) GOTO 60
C       .
