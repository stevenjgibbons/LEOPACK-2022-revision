...
C            -     -                 -        -        -             *
C            optimised with Drifting frame                           C
C                           -                                        C
C Steve Gibbons Tue Nov  6 10:29:45 GMT 2001                         C
...
C
C*********************************************************************
      SUBROUTINE SICRBD( NR,INARR,MHT,MHL,MHM,MHP,MHTR,NBN,KL,NCFM,
...
C
      ...
      PARAMETER      ( NOITM = 30 )
      DOUBLE PRECISION REYSBR, DRFTOP, DRFTOM, DRFTNP, DRFTNM,
     1                 DMVAL, DIFF, DIFFM, REYSBO, GRIO
