C*********************************************************************
C subroutine Recalled coefficient Velocity . Gradient of Theta_0 Add *
C            -                    -          -           -     - -   *
...
C RVGT0A searches through the arrays IHNALP, IHNBET, IHNGAM and TVHI C
...
C
C*********************************************************************
      SUBROUTINE RVGT0A( NR, N1, N2, KL, KU, KLE, IMF, ILN, IRN, INI,
