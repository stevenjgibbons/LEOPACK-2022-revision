C*********************************************************************
C subroutine Diffusion Free Imposed Vector Time step routine opt. ****
C            -         -    -       -      -                      ****
C                                            aZimuthal symmetry      C
C                                             -                      C
C Steve Gibbons Sat Jul 22 20:28:47 BST 2000                         C
...
C MCVDMF. DFIVTZ will advance the solution by one time step (size    C
C DELTAT).                                                           C
C                                                                    C
...
C and MHP.                                                           C
C                                                                    C
C Differs from NIVTSO in that NO diffusion terms are added from      C
C the imposed vector.                                                C
C____________________________________________________________________C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE DFIVTZ( KL, NBN, NCFM, NR, NDRVM, NH, NDCS, MHT, MHL,
     1   MHM, MHP, MHTR, LH, MMAX, M0, NPHPV, NPHPR, NTHP, VEC, SVFDC,
     2   FDCM, PA, DPA, GAUX, GAUW,SHC,DSHC,RVF1,RVF2,RVF3,SF, VF,
     3   XARR, N2, NOIT, LULOG, IPIV, MHIBC, MHOBC, DMAT, DPARS, V0,
     4   V1, V2, V3, V4, DTV, RFI, RFI1, VEC1, RQST1, RQST2, RQST3,
     5   RQSTA, IN0, MHT0, MHL0, MHM0, MHP0, VEC0 )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER KL, NBN, NCFM, NR, NDRVM, NH, NDCS, MHT( * ), MHL( * ),
     1        MHM( * ), MHP( * ), MHTR( * ), LH, MMAX, M0, NPHPV,
     2        NPHPR, NTHP, N2, NOIT, LULOG, IPIV( * ), MHIBC( * ),
     3        MHOBC( * ), IN0( * ), MHT0( * ), MHL0( * ), MHM0( * ),
     4        MHP0( * )
...
C
 ...
 81   FORMAT('dfivtz: Predictor norm = ',1PD16.7)
C
      ITMX = NOIT
      NOIT = 0
 50   CONTINUE
 ...
 83     FORMAT('dfivtz: Max. iterations exceeded.')
        NOIT = -1
        RETURN
      ENDIF
C
...
C
      ...
      CALL NTSVFZ( NR, INARR, MHT, MHL, MHM, MHTR, LH, NCFM,
     1             NBN, MMAX, M0, NTHP, NPHPR, NPHPV, CB1, CB2,
     2             CC, CH, CG, CF, CJ, CM, V0, V1, RVF1, RVF2, RVF3,
     3             SF, VF, PA, DPA, GAUX, GAUW, SHC, DSHC, FDCM,
     4             RFI1, XARR, RQST1, RQST2, RQST3, RQSTA )
C
...
C
 ...
 84   FORMAT('dfivtz: Iteration ',I4,' Solution norm = ',1PD16.7)
