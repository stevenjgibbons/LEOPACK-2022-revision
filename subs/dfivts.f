C*********************************************************************
C subroutine Diffusion Free Imposed Vector Time Step routine *********
C            -         -    -      -    -    -               *********
C Steve Gibbons Thu Jun 29 18:42:28 BST 2000                         C
...
C SFDDMF. DFIVTS will advance the solution by one time step (size    C
C DELTAT).                                                           C
...
C and MHP.                                                           C
C                                                                    C
C Differs from NIVTSR in that NO diffusion terms are added from      C
...
C
C*********************************************************************
      SUBROUTINE DFIVTS( KL, NBN, NCFM, NR, NDRVM, NH, NDCS, MHT, MHL,
