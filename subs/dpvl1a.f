C*********************************************************************
C subroutine Double Precision Vector Laplacian 1 (poloidal) Add ******
C            -      -         -      -         -            -   ******
C Steve Gibbons 13.4.99                                              C
...
C
C*********************************************************************
      SUBROUTINE DPVL1A ( NDIM, NR, NH, MHT, MHL, RI, RO,
...
C Variable declarations - Working variables .........................C
      DOUBLE PRECISION H, LAPFAC, RAD, D0F, D1F, D2F, D3F, D4F,
     1                 DLDL, TOL
...
C
      IF ( NDIM.NE.NR*NH ) THEN
         PRINT *,' Subroutine DPVL1A. Bad dimensions '
...
c
           INDO = ( IRN - 1 )*NH + IIH
           LAPFAC = DLDL(LI,RAD,D0F,D2F,D3F,D4F)
