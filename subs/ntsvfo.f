C*********************************************************************
C subroutine New Transform Solution Vector Forcing term: Optimised ***
C            -   -         -        -      -             -         ***
C Steve Gibbons Fri Jul 14 13:37:47 BST 2000                         *
...
C                                                                    C
C     RVF1      : Work arr. dim. ( 3, NPHP, NTHP, NR )               C
C     RVF2      : Work arr. dim. ( 3, NPHP, NTHP, NR )               C
C     RVF3      : Work arr. dim. ( 3, NPHP, NTHP, NR )               C
C     SF        : Work arr. dim. ( NPHP, NTHP )                      C
C     VF        : Work arr. dim. ( 3, NPHP, NTHP )                   C
...
C
C*********************************************************************
      SUBROUTINE NTSVFO( NR, INARR, MHT, MHL, MHM, MHTR, LH, NCFM,
...
C Variable declarations - Parameters ................................C
     ...
     1                 RVF1( 3, NPHP, NTHP, NR ), GAUX( NTHP ),
     2                 RVF2( 3, NPHP, NTHP, NR ), GAUW( NTHP ),
     3                 RVF3( 3, NPHP, NTHP, NR ), VF( 3, NPHP, NTHP )
...
C     .
      CALL SDVRVO( NTHP, NPHP, LH, IRES, ILNR, IRNR, NR,
...
C     .
      FAC   = -1.0d0*CC
      CALL RVVGTO( NR, LH, MMAX, MHT, MHL, MHM, V0, V1,
...
C     .
      ...
      CALL RQSRVO( RQST2, RVF2, GAUX, PA, DPA, FTF1, FTF2, FTF3,
     1              LH, NTHP, NPHP, MMAX, ZCFA, NR, ILNR, IRNR )
C     .
C     . Evaluate -cg( k x v) + cf[ v x curl v ] in RVF3
C     .
      CALL RVFCIT( NTHP, NPHP, NR, ILNR, IRNR, RVF1,
...
C     .
      CALL RVFRQO( RQST3, RVF3, GAUX, GAUW, PA, DPA, FTF1, FTF2,
...
C     .
      CALL RVFCPO( RVF1, RVF2, RVF3, NPHP, NTHP, NR, ILNR, IRNR )
C     .
...
C     .
      CALL VECOP( ZCFA, ZERO, NR, IOP )
      CALL RQSRVO( RQST1, RVF1, GAUX, PA, DPA, FTF1, FTF2, FTF3,
     1              LH, NTHP, NPHP, MMAX, ZCFA, NR, ILNR, IRNR )
C     .
