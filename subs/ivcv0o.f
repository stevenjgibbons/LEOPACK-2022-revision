C*********************************************************************
C subroutine Identical node Velocity cross Curl Velocity_0 add (Opt) *
C            -              -              -    -        -      -    *
C Steve Gibbons Tue Oct  9 10:13:10 WEST 2001                        C
...
C
C*********************************************************************
      SUBROUTINE IVCV0O( NR, N1, N2, KL, KU, KLE, IMF, ILNRP, IRNRP,
     1    ILNRT, IRNRT, INI, MTI, MLI, MMI, MPI, MTO, MLO, MMO, IN0,
     2    MT0, ML0, MM0, MP0, NBN, NDCS, NDRVS, NDRVM, NFDCM, NBN0,
     3    NDCS0, NDRVS0, NDRVM0, NFDCM0, LH, NTHP, NPHP, MMAX, A,
     4    FAC, XARR, VEC0, SVFDC, SVFDC0, GAUX, GAUW, PA, DPA, FF1,
     5    FF2, FF3, VF1, VF2, VF3, QST, M0 )
      IMPLICIT NONE
C____________________________________________________________________C
