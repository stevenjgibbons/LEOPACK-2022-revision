C*********************************************************************
C subroutine Linear Onset Independent Growth Rate Find ***************
C            -      -     -           -      -    -    ***************
...
C linear convective instability problem :-                           C
C                                                                    C
C  c_a d \Theta/ dt = CD \nabla^2 \Theta                             C
...
C
C*********************************************************************
      SUBROUTINE LOIGRF( NR, LH, M, GRR, GRI, RAY, DPRPAR, INTPAR)
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NR, LH, M, INTPAR( * )
      DOUBLE PRECISION GRR, GRI, RAY, DPRPAR( * )
C____________________________________________________________________C
...
C
c     PRINT *, NCE,' eigenalues converged.'
c     DO IH = 1, NCE
c       WRITE ( 6, 18 ) IH, DR( IH ), DI( IH ), D3( IH )
c     ENDDO
c18   FORMAT('Eval ',I2,' (',f16.7,',',f16.7,') Res = ',f16.7)
C
      RESTOL = 1.0d-5
