C*********************************************************************
C subroutine Magnetic and Convection Vector Diffusion Matrix Form ****
C            -            -          -      -         -      -    ****
C Steve Gibbons Mon Feb  7 11:49:18 GMT 2000                         C
...
C
C*********************************************************************
      SUBROUTINE MCVDMF( KL, NDCS, NBN, NBAND, N2, NR, NH, NDRVS,
