C*********************************************************************
C subroutine Arbitrary node Velocity_0 cross Curl Velocity Add *******
C            -              -        -       -    -        -   *******
...
C
C*********************************************************************
      SUBROUTINE AV0CVA( NR, N1, N2, KL, KU, KLE, IMF, ILNRP, IRNRP,
     1    ILNRT, IRNRT, INI, MTI, MLI, MMI, MPI, MTO, MLO, MMO, IN0,
     2    MT0, ML0, MM0, NBN, NDCS, NDRVS, NDRVM, NFDCM, NNDS, LH,
     3    NTHP, NPHP, MMAX, IWORK, WORK1, WORK2, WORKM, A, FAC, XARR,
     4    VEC0, SVFDC, XARR0, GAUX, GAUW, PA, DPA, FF1, FF2, FF3, VF1,
     5    VF2, VF3, QST  )
      IMPLICIT NONE
C____________________________________________________________________C
...
C
     ...
     2        IPARS( 7 ), NHA, NHB, NHG, INDG, INDSHC, IS
C     .
...
C                 .
                  DPARS( 1 ) = CQTS
C                 .
                  CALL ANNLCA( N1, N2, KL, KU, KLE, IMF, IHB, IHG,
     1      INI, IHD, NBN, ILNRT, IRNRT, NFDCM, NR, NDCS, IS, NDRVS,
     2      NDRVM, IPARS, ANVCVT, A, FAC, XARR, WORK, DPARS, SVFDC,
     3      IHA, IHD0, NNDS, IN0, VEC0, XARR0, IWORK, WORK1, WORK2,
     4      WORKM )
C                 .
                ENDIF
C               .
