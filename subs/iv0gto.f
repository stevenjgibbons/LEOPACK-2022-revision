C*********************************************************************
C subroutine Identical node Velocity_0 . Gradient of Theta add (Opt) *
C            -              -        -   -           -          -    *
C Steve Gibbons Tue Oct  9 09:54:59 WEST 2001                        C
...
C
C*********************************************************************
      SUBROUTINE IV0GTO( NR, N1, N2, KL, KU, KLE, IMF, ILN, IRN, INI,
     ...
     4    SVFDC0, GAUX, GAUW, PA, DPA, FF1, VF1, VF2, SF, SHC, M0 )
      IMPLICIT NONE
C____________________________________________________________________C
...
C           .
            IQSTB = 1
C           .
            CALL SHVECO( LB, MB, ICSB, IQSTB, VF2, GAUX, PA, DPA,
     1                   NTHP, NPHP, LH, M0 )
C           .
...
C           .
            CALL FORSSO( SHC, SF, GAUW, PA, FF1, LH, MMAX,
     1                   NTHP, NPHP, ZCOEF, M0 )
C           .
