C*********************************************************************
C subroutine Adapted Solution Vector LaPlacian ***********************
C            -       -        -      - -       ***********************
C Steve Gibbons Tue Oct 26 12:36:45 GMT 1999                         C
...
C
C*********************************************************************
      SUBROUTINE ASVLP( NR, NDCS, VI, INARRI, MHTI, MHLI, MHMI, ICMP,
