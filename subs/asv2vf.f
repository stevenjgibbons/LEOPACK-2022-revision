C*********************************************************************
C subroutine Adapted Solution Vector to Vector Function **************
C            -       -        -         -      -        **************
C Steve Gibbons Mon Nov  1 08:23:43 GMT 1999                         C
...
C
C*********************************************************************
      SUBROUTINE ASV2VF( NDCS, NTHPTS, NPHPTS, LH, IRES, NBN, NFDCM,
     1                   IR, NR, NDRVS, NDRVM, INARR, MHT, MHL, MHM,
     2                   MHP, MMAX, CHVMFF, V, SVFDC, GAUX, PA, DPA,
     3                   VF, FTF1, FTF2, FTF3, XARR )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NDCS, NTHPTS, NPHPTS, LH, IRES, NBN, NFDCM, IR, NR,
     1        NDRVS, NDRVM, INARR( * ), MHT( * ), MHL( * ), MHM( * ),
     2        MHP( * ), MMAX
      DOUBLE PRECISION V( * ), XARR( NR ), 
     1                 SVFDC( NFDCM, NR, NDRVM+1, NDCS ),
     2                 VF( NPHPTS, NTHPTS, 3), GAUX( NTHPTS )
