C*********************************************************************
C subroutine Adapted Vorticity Matrix All Term add (Optimised) *******
C            -       -         -      -   -         -          *******
C Steve Gibbons Tue Oct  9 10:23:14 WEST 2001                        C
...
C
C*********************************************************************
      SUBROUTINE AVMATO( NR, INARR, MHT, MHL, MHM, MHP, MHTR, NBN, KL,
...
C
      FAC = (-1.0d0)*CC1
      CALL IV0GTO( NR,N1,N2,KL,KL,KLE,IMF,ILNTHE,IRNTHE,INARR,
     ...
     4    SVFDC,GAUX,GAUW,PA,DPA,FTF1,VF1,VF2,SF,SHC,M0)
C
C Now v . Grad (theta_0)
C
      FAC = (-1.0d0)*CC2
      CALL IVGT0O( NR,N1,N2,KL,KL,KLE,IMF,ILNTHE,IRNTHE,INARR,
     1    MHT,MHL,MHM,MHP,MHTR,MHL,MHM,IN0,MT0,ML0,MM0,MP0,
     2    NBN,NDCS,NDRVS,NDRVM,NCFM,NBN,NDCS,NDRVS,NDRVM,
     3    NCFM,LH,NTHP,NPHP,MMAX,A,FAC,XARR,VEC0,SVFDC,
     4    SVFDC,GAUX,GAUW,PA,DPA,FTF1,VF1,VF2,SF,SHC,M0)
...
C
      FAC = (-1.0d0)*CF1
      CALL IV0CVO( NR,N1,N2,KL,KL,KLE,IMF,ILNPOL,IRNPOL,
     ...
     5    FTF3,VF1,VF2,VF3,QST,M0)
C
C Now \curl ( v . Grad ) v_0
C
      FAC = (-1.0d0)*CF2
      CALL IVCV0O( NR,N1,N2,KL,KL,KLE,IMF,ILNPOL,IRNPOL,
     1    ILNTOR,IRNTOR,INARR,MHT,MHL,MHM,MHP,MHTR,MHL,MHM,IN0,
     2    MT0,ML0,MM0,MP0,NBN,NDCS,NDRVS,NDRVM,NCFM,NBN,
     3    NDCS,NDRVS,NDRVM,NCFM,LH,NTHP,NPHP,MMAX,A,FAC,
     4    XARR,VEC0,SVFDC,SVFDC,GAUX,GAUW,PA,DPA,FTF1,FTF2,
