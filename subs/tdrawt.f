C*********************************************************************
C subroutine Two Dimensional Real Array WriTe ************************
C            -   -           -    -     -  -  ************************
C Steve Gibbons Mon Mar 19 15:12:41 MET 2001                         C
C____________________________________________________________________C
C                                                                    C
C The file with logical number LU is already open!                   C
C TDRAWT then writes out the real array F( N1, N2 ) from file LU     C
C with format flag IFORM.                                            C
...
C
C*********************************************************************
      SUBROUTINE TDRAWT( N1, N2, LU, IFORM, F )
      IMPLICIT NONE
C____________________________________________________________________C
