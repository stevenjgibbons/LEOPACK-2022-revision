C*********************************************************************
C subroutine Double Precision Vector Laplacian 3 (temperature ) Add **
C            -      -         -      -         -                -   **
C Steve Gibbons 17.6.99                                              C
C____________________________________________________________________C
C Adds the term to the double precision vector resulting from        C
C the Laplacian of the temperature term.                             C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE DPVL3A ( NDIM, NR, NH, MHT, MHL, RI, RO,
     1                    RVEC, OLDVEC, FAC, ORD )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NDIM, NR, NH, MHT( NH ), MHL( NH )
...
C
      IF ( NDIM.NE.NR*NH ) THEN
         PRINT *,' Subroutine DPVL3A. Bad dimensions '
