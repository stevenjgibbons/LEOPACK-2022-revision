C*********************************************************************
C subroutine Vector Curl Cross Product Coefficients calc. Gen. vers. *
C            -      -    -     -       -                  -          *
C Steve Gibbons Tue Nov 23 07:51:01 GMT 1999                         C
C____________________________________________________________________C
C                                                                    C
C Calculates the coefficients for the non-linear interactions        C
C                                                                    C
C curl( v_{alpha}  x  [ curl v_{beta} ]  )  and                      C
C curl( B_{alpha}  x  [ curl B_{beta} ]  )                           C
C                                                                    C
