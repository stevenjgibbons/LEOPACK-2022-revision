...
C                                                                    C
C     REYSBR    : Solid body rotation to be applied.                 C
C                                                                    C
C  Logical                                                           C
C  -------                                                           C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE SICRBS( NR,INARR,MHT,MHL,MHM,MHP,MHTR,NBN,KL,NCFM,
     ...
     5   IN0,MT0,ML0,MM0,MP0,VEC0,VEC0W,M0,REYSBR)
      IMPLICIT NONE
C____________________________________________________________________C
