C*********************************************************************
C subroutine Radial QST Derivative: Optimised ************************
C            -      --- -           -         ************************
C Steve Gibbons Fri Jul 14 09:27:57 BST 2000                         C
C____________________________________________________________________C
C                                                                    C
C Calculates a derivative of a radial function to a harmonic         C
C in the RQSTO array.                                                C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE RQSTDO ( RQSTO, IR, IH, NBN, IHD, NFDCM, NR, NDVDS,
...
C Variable declarations - Parameters ................................C
     ...
     1        ICOMP
      DOUBLE PRECISION RQSTO( NR, LH*(LH+2), 3 ), DERV( * ), 
