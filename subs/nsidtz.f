C*********************************************************************
C subroutine New Semi-Implicit Dynamo Time step routine          *****
C            -   -    -        -      -                          *****
C                                       aZimuthal symmetry.          C
C                                        -                           C
C Steve Gibbons Sat Jul 22 18:07:33 BST 2000                         C
...
C MCVDMF. NSIDTZ will advance the solution by one time step (size    C
C DELTAT).                                                           C
C____________________________________________________________________C
C                                                                    C
...
C
C*********************************************************************
      SUBROUTINE NSIDTZ( KL, NBN, NCFM, NR, NDRVM, NH, NDCS, MHT, MHL,
     1   MHM, MHP, MHTR, LH, MMAX, M0, NPHPV, NPHPR, NTHP, VEC, SVFDC,
     2   FDCM, PA, DPA, GAUX, GAUW, SHC, DSHC, RVF1, RVF2, RVF3, SF,
     3   VF, XARR, N2, NOIT, LULOG, IPIV, MHIBC, MHOBC, DMAT, DPARS,
     4   V0, V1, V2, V3, V4, DTV, RFI, RFI1, VEC1, RQST1, RQST2,
     5   RQST3, RQSTA )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER KL, NBN, NCFM, NR, NDRVM, NH, NDCS, MHT( * ), MHL( * ),
     1        MHM( * ), MHP( * ), MHTR( * ), LH, MMAX, M0, NPHPR,
     2        NPHPV, NTHP, N2, NOIT, LULOG, IPIV( * ), MHIBC( * ),
     3        MHOBC( * )
...
C
 ...
 81   FORMAT('nsidtz: Predictor norm = ',1PD16.7)
C
      ITMX = NOIT
      NOIT = 0
 50   CONTINUE
 ...
 83     FORMAT('nsidtz: Max. iterations exceeded.')
        NOIT = -1
        RETURN
      ENDIF
C
...
C
     ...
     2             CC, CH, CG, CF, CJ, CM, V0, V1, RVF1, RVF2,
     3             RVF3, SF, VF, PA, DPA, GAUX, GAUW, SHC, DSHC,
     4             FDCM, RFI1, XARR, RQST1, RQST2, RQST3, RQSTA )
...
C
 ...
 84   FORMAT('nsidtz: Iteration ',I4,' Solution norm = ',1PD16.7)
