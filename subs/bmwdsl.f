...
C
C*********************************************************************
      SUBROUTINE BMWDSL( N1, N2, NP, KL, KU, KLE, IPIV, IPIVH,
     1                   A, RHS, U, V, HMAT, VTY, HVTY, UHVTY )
      IMPLICIT NONE
C____________________________________________________________________C
