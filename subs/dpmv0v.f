...
C
C*********************************************************************
      SUBROUTINE DPMV0V ( N1, N2, LVEC, NR, NOH, NNH, KL, KU, KLE,
...
C Variable declarations - Parameters ................................C
     ...
     3        LH, NTHPTS, NPHPTS
      DOUBLE PRECISION RI, RO, AMAT( N1, N2 ), FACV0V,
...
C
      IF ( N2.NE.NNH*NR ) THEN
        PRINT *,' Subroutine DPMV0V.  bad array size'
...
C
      IF ( LVEC.NE.NOH*NR ) THEN
        PRINT *,' Subroutine DPMV0V.  bad vector length'
        PRINT *,' LVEC = ',LVEC
        PRINT *,' NOH = ',NOH,' NR = ',NR
        STOP
      ENDIF
...
C
            FAC = FACV0V
C
            CALL DPMES ( N1, N2, NR, NNH, KL, KU, KLE, IMF, IBETA,
