C*********************************************************************
C subroutine ARRAY POLAR COLOUR (with OPTION) ************************
C            ----- ----- ------       ------  ************************
C Steve Gibbons Tue Feb 27 11:52:55 WET 2001                         C
...
C ARRAY_POLAR_COLOUR_OPTION doesn't tend to trust humans very much   C
...
C                                                                    C
C*********************************************************************
      SUBROUTINE ARRAY_POLAR_COLOUR_OPTION( F, NRAD, NTHE, NLEV,
     1                       CONTL, HUEPOS, HUENEG, CS, SCAL, DELTA,
     2                       ICONTOUR, VALMIN, VALMAX )
      IMPLICIT NONE
C____________________________________________________________________C
C Variable declarations - Parameters ................................C
      INTEGER NRAD, NTHE, NLEV, ICONTOUR
      REAL    F( NRAD, NTHE ), CONTL( NLEV ),
     1        HUEPOS, HUENEG, CS, SCAL, DELTA, VALMIN, VALMAX
C____________________________________________________________________C
C Variable declarations - Working variables .........................C
      INTEGER IRAD, ITHE, NLEV2, ILEV
      REAL    RRED( 17 ), RRED1,
     1        RBLUE( 17 ), RBLUE1,
     2        RGREEN( 17 ), RGREEN1
      REAL    FMIN, FMAX, ZERO, FLIMIT
...
C
      CALL CONT_FILL_POLAR( NRAD, NTHE, F, NLEV2, CONTL )
C
      RETURN
      END
C*********************************************************************
