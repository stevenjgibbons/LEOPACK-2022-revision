...
C*********************************************************************
C subroutine CUT OUT SPHERE PLOT *************************************
C            --- --- ------ ---- *************************************
C Steve Gibbons Sun Apr 29 20:46:39 MET DST 2001                     C
...
C                                                                    C
C*********************************************************************
      SUBROUTINE CUT_OUT_SPHERE_PLOT( NLEV, NPHIRAD, NTHERAD, FRAD,
...
C Variable declarations - Parameters ................................C
     ...
     1        NRADTHE, NPHITHE, NLEVM, IDEV
      REAL    FRAD( NPHIRAD, NTHERAD ), RADV1, RADV2,
     1        FP1( NRADP1, NTHEP1 ), PHIV1,
     2        FP2( NRADP2, NTHEP2 ), PHIV2,
...
C
      IF ( NLEV.EQ.-1 ) THEN
        IF ( NLEVM.GE.17 ) THEN
          NLEV2 = 17
        ELSE
          PRINT *,' Subroutine CUT_OUT_SPHERE_PLOT.'
          PRINT *,' NLEVM = ', NLEVM
...
C
     ...
     1                           VALMIN, VALMAX )
      valmin = valmin - 0.0001
      valmax = valmax + 0.0001
C
