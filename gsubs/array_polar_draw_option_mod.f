C*********************************************************************
C subroutine ARRAY POLAR DRAW (with OPTION) MODified *****************
C            ----- ----- ----       ------  ---      *****************
...
C                                                                    C
C*********************************************************************
      SUBROUTINE ARRAY_POLAR_DRAW_OPTION_MOD( F, NRAD, NTHE, NLEV,
...
C
      CALL CONT_DRAW_POLAR_MOD( NRAD, NTHE, F, NLEV, CONTL,
     1           INW, IPW, INS, IPS, INDNEG, INDPOS )
C
      RETURN
      END
