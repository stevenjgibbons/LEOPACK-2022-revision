C*********************************************************************
C subroutine ARRAY RECT COLOUR (with OPTION) *************************
C            ----- ---- ------       ------  *************************
C Steve Gibbons Tue Feb 27 11:14:42 WET 2001                         C
...
C ARRAY_RECT_COLOUR_OPTION doesn't tend to trust humans very much    C
...
C                                                                    C
C*********************************************************************
      SUBROUTINE ARRAY_RECT_COLOUR_OPTION( F, NPHI, NTHE, NLEV, CONTL,
...
C
      IF ( ICONTOUR.NE.1 .AND. ICONTOUR.NE.2 ) THEN
        PRINT *,' Subroutine ARRAY_RECT_COLOUR_OPTION.'
